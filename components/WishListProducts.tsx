    ...
    <Container>
      ...
      (<>
                        ...
                        <tr key={product?._id} className='border-b'>
                            <td className='px-2 py-4 flex items-center gap-2'>
                                <X  
                                    ...
                                    size={18} 
                                    className='hover:text-red-600 hoverEffect cursor-pointer'
                                />
                                {product?.images && (
                                <Link 
                                ...
                                <Image src={urlFor(product?.images[0]).url()}
                                    ...
                                    width={80}
                                    height={80}
                                    className='rounded-md group-hover:scale-105 hoverEffect h-20 w-20 object-contain'/></Link>
                                )}
                            ...
                            <td className={`p-2 w-24 ${product?.stock as number > 0 ?
        ...
        <div className='flex items-center gap-2'>
            ...
            {visibleProducts >= 10 && (
            <div className='my-5 '>
                <Button variant="outline" onClick={()=> setVisibleProducts(7)}>
                    Load Less
                </Button>
            </div>
            )}
        ...
        {
            favoriteProduct?.length > 0 && (
                <Button className='mb-5 font-semibold'
                    variant='destructive'
                    size="lg"
        ...
        <div className='flex min-h-[400px] flex-col items-center justify-center space-y-6 px-4 text-center'>
            <div className='relative mb-4'>
                <div className='absolute -top-15 right-36 h-4 w-4 rounded-full'>
                    <Heart
