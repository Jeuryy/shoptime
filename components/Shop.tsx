...
const Shop = ({ categories, brands }:Props) => {
    ...
    const [selectedPrice, setSelectedPrice] = useState<string | null>(categoryParams || null);
    ...
    <div className='border-t'>
      <Container className='mt-5'>
        ...
        <div className='flex flex-col md:flex-row gap-5 border-t border-t-shop-dark-green/50'>
            <div className='md:sticky md:top-20 md:self-start md:h-[calc(100vh-160px)] md:overflow-y-auto md:min-w-64 pb-5 md:border-r border-r-shop-dark-green/50'>
                <CategoryList
