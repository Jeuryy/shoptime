    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className='!max-w-2xl max-h-[90vh overflow-y-scroll]'>
            ...
            <div className='mt-4'>
                ...
                {order?.invoice && (
                    <Button className='bg-transparent border text-dark-color/80 mt-2 hover:text-dark-color hover:border-dark-color hover:bg-dark-color/10 hoverEffect'>
                        {order?.invoice?.hosted_invoice_url && (
                            <Link href={order?.invoice?.hosted_invoice_url}
                            target='_blank'>
                                Download Invoice
                            </Link>
                        )}
