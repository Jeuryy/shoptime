        ...
        <Container> 
            ...
            <div className='py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4'>
                <div className='space-y-4'>
                    <Logo/>
                    <SubText>Discover curated furniture collections at Shoptime, 
                        blending style and comfort to elevate your living spaces.
                    </SubText>
                    <SocialMedia className="text-dark-color/60"
                        iconClassName="text-dark-color/60 border-dark-color/60 hover:border-shop-light-green hover:text-shop-dark-green"
                ...
                <div className='space-y-4'>
                    ...
                    <SubText>Subscribe to our newsletter to receive updates and exclusives offers!</SubText>
