    ...
    <div className='py-5 bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center mx-4'>
        <motion.div 
            ...
            <div className='grid grid-cols-1 sm:grid-cols-3 gap-4'>
                <Link
                    href="/"
                    className='flex items-center justify-center px- py-3 font-semibold
                    bg-shop-dark-green text-white rounded-lg hover:bg-shop-light-green transition-all duration-300 shadow-md'>
                ...
                <Link
                    href="/orders"
                    className='flex items-center justify-center px- py-3 font-semibold
                    bg-light-green text-black border border-light-green rounded-lg hover:bg-gray-100 transition-all duration-300 shadow-md'>
