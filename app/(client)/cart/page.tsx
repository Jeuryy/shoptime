...
const CartPage = () => {
  ...
  const [selectedAddress, setSelectedAddresses] = 
            ...
            {groupedItems?.length ? (
              <>
                <div className='flex items-center gap-2 py-5'>
                  <ShoppingBag className='text-dark-color'/>
                  <Title className='mb-1'>Shopping Cart</Title>
                </div>
                <div className='grid lg:grid-cols-3 md:gap-8'>
                                  ...
                                  <div className='flex items-center gap-2'>
                                    <TooltipProvider>
                                      <Tooltip>
                                        ...
                                        <TooltipContent className='font-bold bg-green-500'>
                                          Add to Favorites
                                        </TooltipContent>
                                      </Tooltip>
                                      <Tooltip>
                    ...
                    {/* Order summary for mobilw view*/}
                    <div className='md:hidden fixed bottom-0 left-0 w-full bg-white pt-6 rounded-lg border'>
